	...
	<div id="comm_lnb" style="position: absolute; top: 0; left: 0;">
		<aside
			...
			<ul
				...
				<li><a class="menu top1" href="Introduction.jsp"> IT아시아나클럽 소개 </a></li>

				<li><a class="menu top2" href="#"> 뉴스/이벤트 </a>
					<ul class="submenu sub2"
						style="padding: 15px 0 15px 19px; display: none;">
						<li><a class="subMenu1 index1 TicketInformation" href="#"> 뉴스 </a></li>
						<li><a class="subMenu1 index2 BookOnLine" href="#"> 이벤트 </a></li>
					</ul>
				</li>
			</ul>
		</aside>
