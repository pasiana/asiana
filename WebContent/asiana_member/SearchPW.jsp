...
function SearchPW() {
	...
	document.fr.birthday.value=document.fr.years.value+"-"+document.fr.month.value+"-"+document.fr.day.value;
...
<form action="./ResultPW.me" method="post" name="fr">
...
<div class="boxInner">
<h6 class="h4_type01">비밀번호 찾기</h6>
<p>
회원가입 시 입력한 회원 정보를 입력해주십시오.<br>
비밀번호는 임시 비밀번호로 재발급됩니다.
</p>
...
<td>아이디</td>
<td>
<input type="text"  class="inputType01" name="member_id" onkeyup="this.value=special_filter(this.value)" placeholder="영문은 대소문자 구별하여 입력" style="ime-mode:disabled;">
</td>
</tr>
